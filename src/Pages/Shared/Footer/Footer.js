    ...
    <div className="px-lg-5">
      <div className="row py-5">
        <div className="col-lg-12 mx-auto text-dark text-center">
          <h1 className="display-4 text-white ">SUBSCRIBE OUR NEWSLETTER </h1>
  ...
  <button className="input-group-text btn btn-dark text-white" id="search-btn">Submit</button>
      ...
      <div className="container">
        <div className="row">
          <div className="col-sm-12 col-md-6">
            <h6>Headphone World - A leading Headphone Shop in the World</h6>
            <p className="text-justify">The professional standard and the expertise on quality and services are the pillars of success of Headphone World. It is noticeable that a gap exists between customers expectations and provided products quality & services. As a result, a remarkable number of people trust in brand like us. </p>
          </div>

          <div className="col-xs-6 col-md-3 links">
            <h6>Partners</h6>
            <ul className="footer-links ">
              <li><Link className="text-decoration-none"to="#">Boss</Link></li>
              <li><Link className="text-decoration-none" to="#">JBL</Link></li>
              <li><Link className="text-decoration-none" to="#">UISI</Link></li>
              <li><Link className="text-decoration-none" to="#">Logitech</Link></li>
              <li><Link className="text-decoration-none" to="#">Corsair</Link></li>
              <li><Link className="text-decoration-none" to="#">A4tech</Link></li>
            </ul>
          </div>
      ...
      <div className="container">
        <div className="row">
         ...
         <Link className="text-decoration-none" to="#"> Jannatul Ferdouse</Link>.
            </p>
          </div>
